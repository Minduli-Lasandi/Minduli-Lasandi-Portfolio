        ...
        <section id="projects" className="section section-alt">
            <div className="section-inner">
                ...
                <div className="projects-footer">
                    <p className="projects-footer-text">Showing {recentProjects.length} of {projects.length} projects</p>
                    <div className="projects-footer-btns">
                        <a
                            href="https://github.com/Minduli-Lasandi?tab=repositories"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="view-all-btn view-all-btn--outline"
                        >
                        ...
                        <button onClick={() => navigate('/skills')} className="view-all-btn">
                            <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
