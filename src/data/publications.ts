...
@inproceedings{lasandi-jayatilleke-2026-sinhalegal,
    title = "{S}inha{L}egal: A Benchmark Corpus for Information Extraction and Analysis in {S}inhala Legislative Texts",
    author = "Lasandi, Minduli  and
      Jayatilleke, Nevidu",
    ...
    url = "https://aclanthology.org/2026.loreslm-1.11/",
    doi = "10.18653/v1/2026.loreslm-1.11",
    pages = "114--131",
...
@Under_Review{lasandi2026sinbrief,
  title=SinBrief: An Unsupervised Framework for Abstractive Text Summarisation of Sinhala Legal Documents,
  author="Lasandi, Minduli  and
      Jayatilleke, Nevidu",
  year=2026,
  booktitle = "The 38th Conference on Computational Linguistics and Speech Processing (ROCLING 2026)",
  note={Under Review}
}
